...
<div id="wrapper">\
    <div id="sidebar-wrapper">\
        <ul class="sidebar-nav">\
            ...
            <li><a data-toggle="collapse" href="#tutorials">Tutorials<i class="fas fa-chevron-circle-down"></i></a></li>\
            ...
            <li><a data-toggle="collapse" href="#classes">Classes<i class="fas fa-chevron-circle-down"></i></a></li>\
\
            <div class="collapse" id="classes">\
                <ul class="sidebar-sub">\
                    <li><a href="aggressive_path_follower.html">Aggressive Path Follower</a></li>\
                    <li><a href="apply_velocity_on_event.html">Apply Velocity On Event</a></li>\
